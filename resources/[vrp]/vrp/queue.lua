...
Config.Language = {
	joining = "[BASE] Entrando...",
	connecting = "[BASE] Conectando...",
	err = "[BASE] Não foi possível identificar sua Steam ou Social Club.",
	_err = "[BASE] Você foi desconectado por demorar demais na fila.",
	pos = "[BASE] Você é o %d/%d da fila, aguarde sua conexão",
	connectingerr = "[BASE] Não foi possível adiciona-lo na fila.",
    wlonly = "[BASE] Você não está aprovado na whitelist.",
	banned = "[BASE] Seu passaporte foi revogado na cidade.",
	steam = "[BASE] Você precisa estar com a Steam aberta para conectar."
}
